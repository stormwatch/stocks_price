def ugly_best_profit(prices)
  raise "Priceless stock! Please, provide at least to prices" if prices.empty?
  raise "Single-priced stock. Please, provide at least two prices." if prices.size == 1
  best_buy_price, best_sell_price = prices.combination(2).max_by { |buy_price, sell_price|
